...
$this->widget('zii.widgets.CMenu', array(
    ...
    'items' => array(
        ...
        array('label' => 'Создать', 'url' => Yii::app()->urlManager->createUrl('/userAdmin/admin/postedit'), 'active' => (Yii::app()->controller->getId() == 'admin' && Yii::app()->controller->getAction()->getId() == 'post')),
