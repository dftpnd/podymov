...
class Discussion extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, profile_id, parent_id, date, rating, content, group_id, last_update', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
                    ...
                    'child'=> array(self::HAS_MANY, 'Discussion', 'parent_id'),
                    'parent'=> array(self::BELONGS_TO, 'Discussion', 'parent_id'),
		);
	}
