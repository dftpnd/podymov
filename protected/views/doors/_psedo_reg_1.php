...
<div class='table_t congratulation'>
    <div class='tr_t'>
        ...
        <div class='td_t'>
            ...
            <div class='siglashenie'>
                <h2>Пользовательское соглашение</h2><br/>
                Настоящее Соглашение определяет условия использования Пользователями материалов и сервисов сайта <a class="classic" href='www.atpp.in' >www.atpp.in</a>       (далее — «Сайт»).<br/>
                <h3>1.Общие условия</h3><br/>
                ...
                <h3>2. Обязательства Пользователя</h3><br/>
                ...
                2.7. Пользователь принимает положение о том, что все материалы и сервисы Сайта или любая их часть могут сопровождаться рекламой. Пользователь согласен с тем, что Администрация Сайта не несет какой-либо ответственности и не имеет каких-либо обязательств в связи с такой рекламой.<br/><br/>
                <h3>3. Прочие условия</h3><br/>
            ...
            <div class="isept">
                <input type="checkbox" id="isept"/><label for="isept" onclick="getUserForm()" class='delet_attr_click'>Принимаю соглашение, и хулиганить Не буду</label>
            </div>
        </div>
    </div>
</div>