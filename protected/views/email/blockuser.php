...
<table width="800" style="margin:0 auto;padding:0px;color:#333333;font-family:Arial;font-size:12px;" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td style="font-family:Arial;padding-top:17px;padding-left:17px;padding-right:17px;padding-bottom:50px;"><?php echo Yii::app()->request->baseUrl; ?>
      <h1 style="font-size:20px;">Добрый день!</h1>
     Ваш аккаунт был заблокирован администратором Системы аттестации государственных экспертов.
Для выяснения причин блокировки аккаунта и продолжения работы в системе, обратитесь к администратору.
   </td>
  </tr>
  <tr>
